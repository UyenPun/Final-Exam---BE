...
public class EmailServiceImpl extends BaseService implements EmailService {
	...
	public void sendForgotPasswordEmail(Account account, String forgotPasswordToken) {
		String forgotPasswordUrl = String.format("%s://%s:%d/html/auth/resetPassword/new-password.html?token=%s",
				FRONTEND_PROTOCOL, FRONTEND_HOSTNAME, FRONTEND_PORT, forgotPasswordToken);
